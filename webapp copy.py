...
def predict():
    if request.method == "POST":
        DeleteAllFiles('C:\\workspace\\cakd5\\프로젝트\\2차\\3팀\\ckad5_2nd-main\\web\\static\\aft')  #파일 업로드 후 새로 검사 시작할 때마다 폴더 내 파일 삭제
        DeleteAllFiles('C:\\workspace\\cakd5\\프로젝트\\2차\\3팀\\ckad5_2nd-main\\web\\static\\bef')  # 경로설정필요
...
# local model
    ...
    model = torch.hub.load(
        'ultralytics/yolov5', 'custom', path='C:\\workspace\\cakd5\\프로젝트\\2차\\3팀\\web\\yolov5l.pt', autoshape=True
