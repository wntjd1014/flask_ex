...
#          'C:/Users/admin/project3/web_teacher/semi-epoch1000.pt','custom', autoshape=True
#     )
# model = torch.load('C:/Users/admin/project3/web_teacher/semi-epoch1000.pt')
# sys.path.insert(0, 'C:/Users/admin/project3/web_teacher/semi-epoch1000.pt')
...
def predict():
    if request.method == "POST":
        DeleteAllFiles('C:/Users/admin/project3/web_teacher/static/aft')  #파일 업로드 후 새로 검사 시작할 때마다 폴더 내 파일 삭제
        DeleteAllFiles('C:/Users/admin/project3/web_teacher/static/bef')  # 경로설정필요
...
# local model
    ...
    model = torch.hub.load(
         'ultralytics/yolov5/tree/master/models', 'yolov5s', autoshape=True
